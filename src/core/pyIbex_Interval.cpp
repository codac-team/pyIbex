...
void export_Interval(py::module& m){
    ...
    // .def( "__pow__", pow__)
    .def_property_readonly_static("PI", py::cpp_function([](py::object) { return Interval(Interval::PI); } ))
    .def_property_readonly_static("TWO_PI", py::cpp_function([](py::object) { return Interval(Interval::TWO_PI); } ))
    .def_property_readonly_static("HALF_PI", py::cpp_function([](py::object) { return Interval(Interval::HALF_PI); } ))
    .def_property_readonly_static("EMPTY_SET", py::cpp_function([](py::object) { return Interval(Interval::EMPTY_SET); } ))
    .def_property_readonly_static("ALL_REALS", py::cpp_function([](py::object) { return Interval(Interval::ALL_REALS); } ))
    .def_property_readonly_static("ZERO", py::cpp_function([](py::object) { return Interval(Interval::ZERO); } ))
    .def_property_readonly_static("ONE", py::cpp_function([](py::object) { return Interval(Interval::ONE); } ))
    .def_property_readonly_static("POS_REALS", py::cpp_function([](py::object) { return Interval(Interval::POS_REALS); } ))
    .def_property_readonly_static("NEG_REALS", py::cpp_function([](py::object) { return Interval(Interval::NEG_REALS); } ))

...
PYBIND11_MODULE(thickset, m)
{
  ...
  export_thickInterval(m);
    ...
    bool (*isThickNotInclude_1)(const IntervalVector&, const IntervalVector&, const IntervalVector&) = &ibex::isThickNotInclude;
    bool (*isThickNotInclude_2)(const IntervalVector&, const IntervalVector&, const IntervalVector&, const IntervalVector&) = &ibex::isThickNotInclude;
    m.def("isThickNotInclude", isThickNotInclude_1);
    m.def("isThickNotInclude", isThickNotInclude_2);

    bool (*isThickIntersect_1)(const IntervalVector&, const IntervalVector&, const IntervalVector&) = &ibex::isThickIntersect;
    bool (*isThickIntersect_2)(const IntervalVector&, const IntervalVector&, const IntervalVector&, const IntervalVector&) = &ibex::isThickIntersect;
    ...
    class_<ThickPaving>(m, "ThickPaving")
        ...
        .def(init<IntervalVector&, ThickBoolean> (), "X0"_a, "val"_a=MAYBE)
				.def(init<IntervalVector&, ThickBoolean, LargestFirst& > (), "X0"_a, "val"_a, "bsc"_a)

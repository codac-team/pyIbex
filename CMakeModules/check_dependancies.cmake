...
# FIND_PACKAGE(IbexRobotics REQUIRED)
# if(IBEX_ROBOTICS_FOUND)
#   INCLUDE_DIRECTORIES(${IBEX_ROBOTICS_INCLUDE_DIRS})
#   SET(LIBS ${LIBS} ${IBEX_ROBOTICS_LIBRARIES} )
# else()
#   MESSAGE(FATAL_ERROR "Unable to find IbexLib. Maybe you need to set IBEX_ROBOTICS_ROOT ${IBEX_ROBOTICS_ROOT}")
#   #MESSAGE(WARNING "If ibex is not installer run : \n\t sh travis_script/install_ibexlib.sh /path/to/your/install/dir")
#   #MESSAGE(FATAL_ERROR "where ")
# endif()
